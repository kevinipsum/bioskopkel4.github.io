...
void formatKursiRapi(char kodeKursi[][MAX_KODE_LEN], int jumlah, char *outBuff, size_t buffSize) {
    SeatGroup groups[MAX_SEATS];
    int groupCount = 0;
